        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 bg-white dark:bg-gray-950">
            ...
            <main class="relative z-10 flex flex-col gap-10">
                ...
                <header class="text-center">
                    <h1 class="text-2xl sm:text-3xl font-semibold text-gray-900 dark:text-gray-100 flex items-center justify-center gap-2">
                ...
                <section aria-labelledby="map-heading" class="space-y-4">
                    <h2 id="map-heading" class="text-xl font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                ...
                <section aria-labelledby="flight-heading" class="space-y-4">
                    <h2 id="flight-heading" class="text-xl font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                    ...
                    <div class="pl-6">
                        ...
                        <strong>Departure Time:</strong> {{ date('M j, Y, g:i A', strtotime($trip->flight->departure_time)) }}<br />
                        <strong>Arrival Time:</strong> {{ date('M j, Y, g:i A', strtotime($trip->flight->arrival_time)) }}<br />
                    </div>
                ...
                <section aria-labelledby="accommodation-heading" class="space-y-4">
                    <h2 id="accommodation-heading" class="text-xl font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                    ...
                    <div class="pl-6">
                        ...
                        <br />
                        <strong>Check-in:</strong> {{ date('M j, Y, g:i A', strtotime($trip->accommodation->check_in)) }}<br />
                        <strong>Check-out:</strong> {{ date('M j, Y, g:i A', strtotime($trip->accommodation->check_out)) }}<br />
                    </div>
